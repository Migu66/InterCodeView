  ...
  const features = [
    {
      ...
      description: 'Practica con ejercicios típicos de entrevistas técnicas'
    },
    {
      icon: '🤖',
      title: 'Corrección IA',
      description: 'Recibe feedback detallado y personalizado al instante'
    },
    {
      icon: '📊',
    ...
    <div className="min-h-screen bg-black text-white overflow-hidden relative">
        ...
        <div className="container mx-auto px-6 pt-20 pb-32">
          <div className={`text-center transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <p className="text-xl text-gray-400 max-w-3xl mx-auto mb-12 animate-fade-in-up animation-delay-400">
              Practica con ejercicios reales, recibe corrección instantánea con IA, 
              y mejora tus habilidades de programación para{' '}
            ...
            <div className="max-w-4xl mx-auto animate-fade-in-up animation-delay-800">
              <div className="bg-gray-900 rounded-lg overflow-hidden border border-green-500/30 shadow-2xl shadow-green-500/20">
                <div className="bg-gray-800 px-4 py-3 flex items-center gap-2 border-b border-green-500/30">
                  ...
                  <span className="text-xs text-green-400 ml-4 font-mono">code-challenge.py</span>
                </div>
                <div className="p-6 font-mono text-sm text-left">
                  <div className="space-y-2">
                    ...
                    <div className="flex">
                      ...
                      <span className="text-green-400 ml-4 animate-pulse">✓ ¡Excelente solución! 🎉</span>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <footer className="relative border-t border-green-500/30 bg-black/50 backdrop-blur-sm py-8 mt-20">
        <div className="container mx-auto px-6 text-center text-gray-500">
          <p>&copy; 2025 InterCodeView. Preparándote para el éxito.</p>
        </div>
      </footer>
    </div>
  );
